...
// in riff/test/features/auth/signup/logic/cubit/signup_cubit_test.dart.
...
import 'package:riff/features/auth/login/data/models/login_response.dart'
    as _i7;
import 'package:riff/features/auth/login/data/repos/login_repo.dart' as _i6;
import 'package:riff/features/auth/signup/data/models/signup_request_body.dart'
    as _i5;
import 'package:riff/features/auth/signup/data/repos/signup_repo.dart' as _i3;
...
class MockSignupRepo extends _i1.Mock implements _i3.SignupRepo {
  MockSignupRepo() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.ApiResult<void>> signUp(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLoginRepo extends _i1.Mock implements _i6.LoginRepo {
  MockLoginRepo() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.ApiResult<_i7.LoginResponse>> login(
    _i8.LoginRequestBody? body,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i2.ApiResult<_i7.LoginResponse>> loginWithGoogle(
    String? idToken,
  ) =>
      (super.noSuchMethod(
