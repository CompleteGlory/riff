...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeedState<T>);
}
...
/// @nodoc
class $FeedStateCopyWith<T,$Res>  {
$FeedStateCopyWith(FeedState<T> _, $Res Function(FeedState<T>) __);
}


/// Adds pattern-matching-related methods to [FeedState].
extension FeedStatePatterns<T> on FeedState<T> {
...
class Initial<T> implements FeedState<T> {
  const Initial();
...
class Loading<T> implements FeedState<T> {
  const Loading();
...
class Success<T> implements FeedState<T> {
...
@override
String toString() {
  return 'FeedState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $FeedStateCopyWith<T, $Res> {
...
class Error<T> implements FeedState<T> {
...
@override
String toString() {
  return 'FeedState<$T>.failure(apiErrorModel: $apiErrorModel)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $FeedStateCopyWith<T, $Res> {
