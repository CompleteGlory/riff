...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeletePostState);
}
...
$DeletePostStateCopyWith(DeletePostState _, $Res Function(DeletePostState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function()?  success,TResult Function( ApiErrorModel errors)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function()  success,required TResult Function( ApiErrorModel errors)  failure,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function()?  success,TResult? Function( ApiErrorModel errors)?  failure,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Initial implements DeletePostState {
  const Initial();
...
class Loading implements DeletePostState {
  const Loading();
...
class Success implements DeletePostState {
  const Success();
...
class Failure implements DeletePostState {
...
@override
String toString() {
  return 'DeletePostState.failure(errors: $errors)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $DeletePostStateCopyWith<$Res> {
