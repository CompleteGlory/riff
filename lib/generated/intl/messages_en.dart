...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(platform) => "Play on ${platform}";

  static String m10(date) => "Last seen ${date}";

  static String m11(n) => "Last seen ${n}m ago";

  static String m12(time) => "Last seen today at ${time}";

  static String m13(time) => "Last seen yesterday at ${time}";

  static String m14(time) => "Recording, ${time}";

  static String m15(name) => "Replying to ${name}";

  static String m16(name) =>
      "${name} wants to send you a message.\nThey can\'t see that you\'ve viewed this request.";

  static String m17(seconds) => "You can ask for another code in ${seconds}s";

  static String m18(platform) => "Sharing from ${platform}";

  static String m19(reason) => "Sign-in failed: ${reason}";

  static String m20(platform) => "Watch on ${platform}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "aboutUsContactLabel": MessageLookupByLibrary.simpleMessage("Get in touch"),
    ...
    "aboutUsTagline": MessageLookupByLibrary.simpleMessage(
    ...
    "attachMedia": MessageLookupByLibrary.simpleMessage("Attach Media"),
    ...
    "blockedUsersDrawer": MessageLookupByLibrary.simpleMessage("Blocked Users"),
    ...
    "chooseVideo": MessageLookupByLibrary.simpleMessage("Choose a video"),
    "clearFilter": MessageLookupByLibrary.simpleMessage("Clear"),
    "commentCannotBeEmpty": MessageLookupByLibrary.simpleMessage(
      "Comment cannot be empty",
    ),
    "commentDeleted": MessageLookupByLibrary.simpleMessage("Comment deleted"),
    "commentUpdated": MessageLookupByLibrary.simpleMessage("Comment updated"),
    ...
    "createAnAccountBtn": MessageLookupByLibrary.simpleMessage(
      "Create An Account",
    ),
    ...
    "deleteAccountCancel": MessageLookupByLibrary.simpleMessage("Cancel"),
    "deleteAccountConfirmAction": MessageLookupByLibrary.simpleMessage(
      "Delete",
    ),
    "deleteAccountConfirmBody": MessageLookupByLibrary.simpleMessage(
      "Your account and all of your content will be permanently deleted. This can\'t be undone.",
    ),
    ...
    "deleteAccountHeadline": MessageLookupByLibrary.simpleMessage(
      "Permanently delete your Riff account",
    ),
    "deleteAccountMenuItem": MessageLookupByLibrary.simpleMessage(
      "Delete account",
    ),
    ...
    "deleteAccountRemovedContent": MessageLookupByLibrary.simpleMessage(
      "Your posts, reels, comments and likes",
    ),
    ...
    "deleteAccountRemovedProfile": MessageLookupByLibrary.simpleMessage(
      "Your profile — name, username, email, bio, photo, instruments and genres",
    ),
    "deleteAccountRemovedSocial": MessageLookupByLibrary.simpleMessage(
      "Your followers, the people you follow, and your blocked list",
    ),
    ...
    "deleteAccountWarning": MessageLookupByLibrary.simpleMessage(
      "This can\'t be undone. Your account and everything in it is deleted straight away.",
    ),
    ...
    "deleteForEveryoneBtn": MessageLookupByLibrary.simpleMessage(
      "Delete for everyone",
    ),
    "deleteMessageOption": MessageLookupByLibrary.simpleMessage(
      "Delete message",
    ),
    ...
    "describeTheFeature": MessageLookupByLibrary.simpleMessage(
    ...
    "emailNotReceived": MessageLookupByLibrary.simpleMessage(
    ...
    "emailSettingsLabel": MessageLookupByLibrary.simpleMessage("Email Address"),
    ...
    "exitAppTitle": MessageLookupByLibrary.simpleMessage("Exit App"),
    "exitBtn": MessageLookupByLibrary.simpleMessage("Exit"),
    ...
    "falseInformation": MessageLookupByLibrary.simpleMessage(
      "False information",
    ),
    "featureRequestSubmitted": MessageLookupByLibrary.simpleMessage(
      "Feature request submitted. Thank you!",
    ),
    "featureRequestTitle": MessageLookupByLibrary.simpleMessage(
      "Feature Request",
    ),
    "featureTitleHint": MessageLookupByLibrary.simpleMessage(
      "e.g. Dark mode for comments",
    ),
    "featureTitleLabel": MessageLookupByLibrary.simpleMessage("Feature title"),
    "feedTitle": MessageLookupByLibrary.simpleMessage("Feed"),
    "flaggedComment": MessageLookupByLibrary.simpleMessage("Flagged Comment"),
    "flaggedPost": MessageLookupByLibrary.simpleMessage("Flagged Post"),
    "flashAuto": MessageLookupByLibrary.simpleMessage("Flash automatic"),
    ...
    "groupDescriptionLabel": MessageLookupByLibrary.simpleMessage(
      "Description",
    ),
    ...
    "groupNoDescription": MessageLookupByLibrary.simpleMessage(
      "No description",
    ),
    ...
    "instrumentsFilter": MessageLookupByLibrary.simpleMessage("Instruments"),
    "instrumentsSection": MessageLookupByLibrary.simpleMessage("Instruments"),
    ...
    "joinBtn": MessageLookupByLibrary.simpleMessage("Join"),
    "keepBtn": MessageLookupByLibrary.simpleMessage("Keep"),
    ...
    "likeBtn": MessageLookupByLibrary.simpleMessage("Like"),
    "likedYourComment": MessageLookupByLibrary.simpleMessage(
      "liked your comment.",
    ),
    "likedYourPost": MessageLookupByLibrary.simpleMessage("liked your post."),
    ...
    "loadingPost": MessageLookupByLibrary.simpleMessage("Loading post…"),
    ...
    "notificationSetUpBtn": MessageLookupByLibrary.simpleMessage("Set up"),
    ...
    "openExternalLink": MessageLookupByLibrary.simpleMessage("Open link"),
    ...
    "passwordReqNumber": MessageLookupByLibrary.simpleMessage("One number"),
    "passwordReqSpecial": MessageLookupByLibrary.simpleMessage(
      "One special character",
    ),
    "passwordReqUppercase": MessageLookupByLibrary.simpleMessage(
      "One uppercase letter",
    ),
    "passwordStrengthFair": MessageLookupByLibrary.simpleMessage("Fair"),
    "passwordStrengthGood": MessageLookupByLibrary.simpleMessage("Good"),
    ...
    "photoMode": MessageLookupByLibrary.simpleMessage("Photo"),
    "playOnPlatform": m9,
    ...
    "pleaseDescribeBug": MessageLookupByLibrary.simpleMessage(
    ...
    "ppSection1Title": MessageLookupByLibrary.simpleMessage("1. Introduction"),
    ...
    "ppSection5Title": MessageLookupByLibrary.simpleMessage("5. Data Security"),
    ...
    "privateAccount": MessageLookupByLibrary.simpleMessage("Private Account"),
    ...
    "proceedToLogin": MessageLookupByLibrary.simpleMessage("Proceed to Login"),
    ...
    "releaseToStop": MessageLookupByLibrary.simpleMessage("Release to stop"),
    ...
    "reportLabel": MessageLookupByLibrary.simpleMessage("Report"),
    "reportPostOption": MessageLookupByLibrary.simpleMessage("Report Post"),
    "reportPostTitle": MessageLookupByLibrary.simpleMessage("Report Post"),
    "reportSubmittedThankYou": MessageLookupByLibrary.simpleMessage(
      "Report submitted. Thank you.",
    ),
    "requestAFeatureDrawer": MessageLookupByLibrary.simpleMessage(
      "Request a Feature",
    ),
    ...
    "selectGenresTitle": MessageLookupByLibrary.simpleMessage("Select Genres"),
    ...
    "shareYourIdeas": MessageLookupByLibrary.simpleMessage("Share your ideas"),
    ...
    "sharedPost": MessageLookupByLibrary.simpleMessage("Shared post"),
    ...
    "spotifyConnectRetry": MessageLookupByLibrary.simpleMessage("Try again"),
    "spotifyConnectUnavailable": MessageLookupByLibrary.simpleMessage(
      "Spotify isn\'t available in this version of Riff.",
    ),
    "spotifyConnectedNotShared": MessageLookupByLibrary.simpleMessage(
      "Connected to Spotify, but we couldn\'t tell Riff — others won\'t see your track yet.",
    ),
    "startedFollowingYou": MessageLookupByLibrary.simpleMessage(
      "started following you.",
    ),
    "step1Of2": MessageLookupByLibrary.simpleMessage("Step 1 of 2"),
    "step2Of2": MessageLookupByLibrary.simpleMessage("Step 2 of 2"),
    ...
    "unfollowBtn": MessageLookupByLibrary.simpleMessage("Unfollow"),
    ...
    "videoMode": MessageLookupByLibrary.simpleMessage("Video"),
    "videoTooLarge": MessageLookupByLibrary.simpleMessage(
      "That video is too large to upload. Please choose a shorter clip.",
    ),
    ...
    "whatDoYouPlay": MessageLookupByLibrary.simpleMessage("What do you play?"),
